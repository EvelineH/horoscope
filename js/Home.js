...
<div id="mainContainer">
    ...
    <nav id="navigationBar" class="navigationBar">
        <a href="/horoscope/" class="nav__link" data-link>
            Home<img src="/horoscope/assets/icon-home.jpg" width=15px height=15px style="padding:3px"></a>
        <a href="/horoscope/general" class="nav__link" data-link>
            General<img src="/horoscope/assets/icon-general.jpg" width=15px height=15px style="padding:3px"></a>
        <a href="/horoscope/celebrities" class="nav__link" data-link>
            Celebrities<img src="/horoscope/assets/icon-celebrities.jpg"width=15px height=15px style="padding:3px"></a>
        <a href="/horoscope/jobs" class="nav__link" data-link>Jobs</a>
        <a href="/horoscope/compatibility" class="nav__link" data-link>
            Love Compatibility<img src="/horoscope/assets/icon-compatibility.jpg" width=15px height=15px style="padding:3px"></a>
        <a href="/horoscope/game" class="nav__link" data-link>
            Guess Sign<img src="/horoscope/assets/icon-game.jpg" width=15px height=15px style="padding:3px"></a>
